...
public class HPZX_GRZXJC {
	...
	private Integer nd;
	private Integer yd;
	private String zx1; //药比抗菌比奖惩
	private String zx2; //报病卡奖惩
	private Double zx3; //劳动纪律奖惩
	private Double zx4; //规范服务
	private Double zx5; //表扬奖励
	private Double zx6; //全面质量奖惩（医技）
	private Double zx7; //全面质量奖惩（护理）
	private Double zx8; //纠纷投诉
	private Double zx9; //护理质量奖惩
	private Double zx10; //胃肠镜劳务
	private Double zx11; //个人专项-其它
	private Double zx12; //门急诊处方不合理用药奖惩
	private Double zx13; //大肠癌筛查加班
	private Double zx14; //肠道门诊加班费
	private Double zx15;
	private Double zx16;
	private Double zx17;
	private Double zx18;
	...
	public String toString() {
		return "HPZX_GRZXJC [lsh=" + lsh + ", ygbh=" + ygbh + ", ksnm=" + ksnm
				+ ", nd=" + nd + ", yd=" + yd + ", zx1=" + zx1 + ", zx2=" + zx2
				+ ", zx3=" + zx3 + ", zx4=" + zx4 + ", zx5=" + zx5 + ", zx6="
				+ zx6 + ", zx7=" + zx7 + ", zx8=" + zx8 + ", zx9=" + zx9
				+ ", zx10=" + zx10 + ", zx11=" + zx11 + ", zx12=" + zx12
				+ ", zx13=" + zx13 + ", zx14=" + zx14 + ", zx15=" + zx15
				+ ", zx16=" + zx16 + ", zx17=" + zx17 + ", zx18=" + zx18
				+ ", zx19=" + zx19 + ", zx20=" + zx20 + ", zx21=" + zx21
				+ ", cjr=" + cjr + ", cjsj=" + cjsj + ", xgr=" + xgr
				+ ", xgsj=" + xgsj + ", zt=" + zt + ", ksmc=" + ksmc
				+ ", ygxm=" + ygxm + "]";
	}
