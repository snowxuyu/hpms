			...
			$(function(){
				...
				$("#data").datagrid({
					...
					onDblClickRow:function(rowIndex, rowData){
						/* $("#zxDiv").load("jjfp/rlcbzx/query/ck/nd",{"nd":rowData.nd}); */
						window.location.href='<%=basePath %>jjfp/rlcbzx/query/ck/nd?nd='+rowData.nd;
					}
				});
			})
		</script>
