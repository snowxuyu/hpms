    ...
    $(function(){
        ...
        pager.pagination({    
            buttons:[{
                ...
                handler:function(){
                	var url="<%=basePath %>qmys/cx/ny/fp/lb/exportExcel?nd=<%=nd %>&yd=<%=yd %>&ksbh=<%=ksbh %>&fpyz=<%=fpyz %>&xmlbdm=<%=xmlbdm %>&xmlbmc=<%=xmlbmc %>";
...
<body class="easyui-layout">
	<div title="<%=nd %>年<%=yd %>月安亭医院<%=xmlbmc %>标化工作量明细" data-options="region:'center'">
		<table id="data"></table>
	</div>
</body>
</html>