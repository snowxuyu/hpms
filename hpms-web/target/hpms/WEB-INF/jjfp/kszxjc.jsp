...
<head>
	...
	<script type="text/javascript">
		$(function(){
			...
			//获取值为0的列
			$("table tr th[field='zx5']").attr("display", "none");
			...
			$("#xzksBtn").click(function(){
				...
				$("#mh_dg").datagrid({
			        ...
			        onClickRow: function(rowIndex, mh_selectedRow) {
			        	...
			        	$("#ksmc").combobox("setValue", mh_selectedRow.ksnm);
			        	//关闭模糊查询的页面
			...
			$("#mh_cxBtn").click(function(){
				...
				mh_searchParam['ksmc'] = $("#mh_cxnr").textbox("getValue");
...
<body class="easyui-layout">
	<div title="科室专项奖惩检索" class="search-condition" data-options="region:'north', collapsible:false">
		<fieldset>
	...
	<div title="科室专项奖惩维护" data-options="region:'center'">
		<table id="dg">
			 <thead>
				<tr>
	...
	<div id="tb">
		...
		<a id="exportBtn" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-download',plain:true">导出奖金</a>
	</div>
		...
		<form id="form" method="post">
			<table>
				<tr>
					...
					<td>科室名称<span class="need">*</span>:</td> 
					<td>
						<input id="ksmc" class="easyui-combobox" readonly="true" required="true" data-options="valueField:'id', textField:'text', url:'yljx/ks/query'"/>
						<input id="_ksnm" name="ksnm" type="hidden">
						<a id="xzksBtn" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-search'"> 选择科室</a>
					</td>
				</tr>
				<tr>
					<td>药比抗菌比奖惩:</td> 
	...
	<div id="mh_window" title="员工信息-模糊查询" class="easyui-window" data-options="maximizable:true,minimizable:true" style="height:400px; width:550px">
		<div id="mh_dg_tb">
		科室名称<span class="need">*</span>:<input id="mh_cxnr" class="easyui-textbox" data-options="iconCls:'icon-search'"/>
		...
		<table id="mh_dg" data-options="fit:true" toolbar="#mh_dg_tb">
			<thead>
				<tr>
					<th field="ksnm" hidden="true"></th>
					<th field="ksbm" width="100">科室编码</th>
	...
	<div id="importWin" title="科室专项奖金导入" class="easyui-window win" data-options="maximizable:false,minimizable:false">
	...
	<div id="exportWin" title="科室专项奖金导出" class="easyui-window win" data-options="maximizable:false,minimizable:false">
