...
<script type="text/javascript">
	...
	function querySum(){
		...
		$('#dg').datagrid({
			queryParams :{nd:nd1},
			url:'<%=basePath %>jjfp/HpysRlcbzxAction/queryNdSum',
			method:'post',
			...
			<table id="dg" class="easyui-datagrid" data-options="fitColumns: true ,
	               ...
	               <thead>
	               		<tr>
	               			...
	               			<th  data-options="field:'sjzje',width:100">执行总金额(万)</th>
	               			<th  data-options="field:'zzxl',width:70">执行率(%)</th>
