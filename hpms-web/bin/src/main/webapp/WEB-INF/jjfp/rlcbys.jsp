	...
	<head>
		...
		<script>
			$(function(){
				...
				$("#data").datagrid({
					url:'jjfp/rlcbys/query',
					singleSelect:true,
		            toolbar:"#tb",
		            fit:true,
		            fitColumns:true,
					onDblClickRow:function(rowIndex, rowData){
						/* $("#ysDiv").load("jjfp/rlcbys/query/nd",{"nd":rowData.nd}); */
						window.location.href='<%=basePath %>jjfp/rlcbys/query/nd?nd='+rowData.nd;
					}
				});
			})
		</script>
...
<body class="easyui-layout">
	<div class="search-condition" title="人力成本预算筛选" data-options="region:'north'">
		<fieldset>
